                    ...
                    <div class="row">
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-info">
                                ...
                                <a href="#" onclick="document.getElementById('id01').style.display='block'" style="width:auto;">More info <i class="fas fa-arrow-circle-right"></i></a>
...
else
{
   ...
   header("Location:http://localhost:eproject/index.php");
...
?>
                                    <form class="modal-content animate" action="" name="log" method="post">
                                        <div class="imgcontainer">
                                            <span onclick="document.getElementById('id01').style.display='none'" class="close" title="Close Modal">&times;</span>
                                            <h4 style="color: black;">Add usere here!</h4>
                                        </div>
           

                                        <div class="container">
                                            <label for="uname" style="color: black;"><b>Name:</b></label>
                                            ...
                                            <br>
                                            <label for="uname" style="color: black;"><b>Role</b></label>
                                            <select class="form-control" name="role">
                            
                            <option value="1">Admin</option>
                            <option value="2">tester</option>
                            <option value="3">manufecture</option>
                        </select>
                                            <br>
